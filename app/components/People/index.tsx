            ...
            <div className="mx-auto max-w-7xl px-6">
                ...
                <div className='grid grid-cols-1 lg:grid-cols-12 space-x-1 pt-10 lg:pt-32 lg:mt-20'>
                    ...
                    <div className='col-span-6 flex flex-col justify-evenly lg:pl-24 mt-10 lg:mt-0'>
                        ...
                        <Link href={'https://designify-web.vercel.app/'} target="_blank" rel="noopener noreferrer" className="text-electricblue text-lg font-medium flex gap-2 mx-auto lg:mx-0 pt-5 lg:pt-0">
