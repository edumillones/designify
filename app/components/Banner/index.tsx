            ...
            <div className="mx-auto max-w-7xl pt-20 sm:pb-24 px-6">
                ...
                <div className='grid grid-cols-1 lg:grid-cols-12'>
                    ...
                    <div className='col-span-7 flex flex-col justify-evenly relative'>
                        ...
                        <h3 className='text-black opacity-75 text-lg font-normal text-center lg:text-start pt-8'>Creamos diseños de calidad y experiencias memorables para aumentar tu presencia a través de tu portafolio virtual, haz realidad tu visión.</h3>
