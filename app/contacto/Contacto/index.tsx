            ...
            <div className="space-y-6">
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <a href="mailto:designify.pe@gmail.com" className="text-blue hover:underline">designify.pe@gmail.com</a>
                </div>
              </div>
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <a href="tel:+51942538945" className="text-blue hover:underline">+51 942 538 945</a>
                </div>
              </div>
            </div>
            <div className="mt-8">
