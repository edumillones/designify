...
const names = [
    ...
    },
    {
        ...
        subscriber: 0.50,             
        button: "Adquirir ahora",
        option: 'Panel de Control, Hosting web (Ilimitado) + Dominio (.com) + SSL Certificado, Cuentas de Correo Ilimitados, Soporte Tecnico 24/7 por parte de nuestro equipo.',
        category: 'monthly',
        imgSrc: '/assets/pricing/starone.svg',
    },
    {
        ...
        subscriber: 0.50,
        button: "Adquirir ahora",
        option: 'Hosting web (10GB) + Dominio (.com) + SSL Gratuito, Hasta 5 cuentas de Correo',
        category: 'monthly',
        imgSrc: '/assets/pricing/startwo.svg',
    },
    {
        ...
        subscriber: 0.50,
        button: "Adquirir ahora",
        option: 'Hosting web (5GB) + Dominio (.com), SSL Gratuito, Maximo 2 cuentas de correo',
        category: 'monthly',
        imgSrc: '/assets/pricing/starthree.svg',
    },
]
    ...
    return (
        <div id="pricing" className='pricing-bg relative py-10'>
            ...
            <div className='mx-auto max-w-7xl sm:py-20 lg:px-8 my-16'>
                <h3 className='text-center text-4xl sm:text-65xl font-black'>Nuestros Paquetes.</h3>
